...
- (void)show
{
    ...
    SIAlertViewController *viewController = [[[SIAlertViewController alloc] initWithNibName:nil bundle:nil] autorelease];
...
- (void)updateMessageLabel
{
    if (self.message) {
        if (!self.messageLabel) {
            self.messageLabel = [[[UILabel alloc] initWithFrame:self.bounds] autorelease];
...
- (void)setupButtons
{
    self.buttons = [[[NSMutableArray alloc] initWithCapacity:self.items.count] autorelease];
